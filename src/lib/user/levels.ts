...
export const LEVEL_REWARDS: LevelReward[] = [
  ...
  // Exclusive cosmetics start at level 5
  { level: 5,  label: "Rose Ink",               type: "cosmetic",  itemId: "color_#FB7185" },
  { level: 6,  label: "75 Ink Drops",           type: "ink_drops", amount: 75 },
  { level: 7,  label: "100 Ink Drops",          type: "ink_drops", amount: 100 },
  { level: 8,  label: "Lime Ink",               type: "cosmetic",  itemId: "color_#84CC16" },
  { level: 9,  label: "150 Ink Drops",          type: "ink_drops", amount: 150 },
  { level: 10, label: "Soft Glow (Rose)",       type: "cosmetic",  itemId: "aura_glow_01:#FB7185" },
  { level: 11, label: "200 Ink Drops",          type: "ink_drops", amount: 200 },
  { level: 12, label: "Sky Ink",                type: "cosmetic",  itemId: "color_#0EA5E9" },
  { level: 13, label: "300 Ink Drops",          type: "ink_drops", amount: 300 },
  { level: 14, label: "Sparkle (Rose)",         type: "cosmetic",  itemId: "aura_glow_02:#FB7185" },
  { level: 15, label: "450 Ink Drops",          type: "ink_drops", amount: 450 },
  { level: 17, label: "Flame (Sky)",            type: "cosmetic",  itemId: "aura_glow_03:#0EA5E9" },
  { level: 18, label: "500 Ink Drops",          type: "ink_drops", amount: 500 },
  { level: 20, label: "Word Warrior",           type: "title" },
  { level: 22, label: "Indigo Ink",             type: "cosmetic",  itemId: "color_#6366F1" },
  { level: 24, label: "600 Ink Drops",          type: "ink_drops", amount: 600 },
  { level: 25, label: "Pulse (Lime)",           type: "cosmetic",  itemId: "aura_glow_04:#84CC16" },
  { level: 27, label: "750 Ink Drops",          type: "ink_drops", amount: 750 },
  { level: 30, label: "Frost (Indigo)",         type: "cosmetic",  itemId: "aura_glow_05:#6366F1" },
  { level: 33, label: "1000 Ink Drops",         type: "ink_drops", amount: 1000 },
  { level: 37, label: "1250 Ink Drops",         type: "ink_drops", amount: 1250 },
