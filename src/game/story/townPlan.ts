...
export const TOWN = {
  ...
  buildings: [
    ...
    { id: 'nell', x: 272, y: 560, roof: 0x987151 },
    { id: 'baker', x: 208, y: 176, roof: 0x567e70 },
    { id: 'guard', x: 816, y: 816, roof: 0x526d83 },
    { id: 'mapmaker', x: 496, y: 560, roof: 0x9a7353 },
    { id: 'gardener', x: 816, y: 560, roof: 0x987151 },
    { id: 'tea-room', x: 784, y: 176, roof: 0x987151 },
    { id: 'guest', x: 1104, y: 816, roof: 0x826f76 },
    { id: 'scriptorium', x: 432, y: 176, roof: 0x626f87 },
  ],
  streets: [
    [608, 32, 64, 32],
    [608, 64, 64, 1248],
