...
export const ROOM_LAYOUTS: Record<VillageBuildingId, FurnitureSpec[]> = {
  ...
  guest: [item('bed',64,224,'CHECK THE BED','Fresh sheets. A pencil waits on the pillow.',0x967b8b),
    item('bed',624,224,'CHECK THE OTHER BED','Someone has folded a towel into a very uncertain bird.',0x967b8b),
    item('table',312,280,'READ THE GUEST BOOK','“Stayed one night. Stayed six more. — Oren”',0x967b8b),
