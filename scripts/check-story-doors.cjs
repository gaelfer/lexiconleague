...
(async()=>{
 ...
 try{
  ...
  await move('x',656);await move('y',1296);await move('x',848);
  ...
  await move('y',400);await page.keyboard.press('s');
  ...
  await page.waitForTimeout(500);await move('x',656);await move('y',112);
